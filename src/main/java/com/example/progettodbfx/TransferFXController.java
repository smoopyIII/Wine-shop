...
public class TransferFXController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        for (List<Integer> innerList2 : BuyWineFXController.listOfList) {
            float price_tot = 0;
    ...
    public void buyIsClicked() throws IOException {
        ...
        if (inputValid) {
            ...
            for (List<Integer> innerList : BuyWineFXController.listOfList) {
                if (innerList.get(1) != 0) {
                    ...
                    out.println(innerList.get(0));            //ID VINO
                    out.println(innerList.get(1));         //QUANTITA'
                    out.println(clientId);
                    out.println(contpurchase);
                    out.println(price_tot);    //PREZZO TOTALE
                }
            }
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(MainFX.class.getResource("Home_client.fxml"));
