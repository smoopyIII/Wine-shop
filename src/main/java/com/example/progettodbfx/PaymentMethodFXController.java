...
public class PaymentMethodFXController implements Initializable {
    ...
    public void TransferIsClicked() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(MainFX.class.getResource("transfer_page.fxml"));
        Stage window = (Stage) transfer_btn.getScene().getWindow();
        window.setScene(new Scene(fxmlLoader.load()));
    }

    public void CreditCardIsClicked() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(MainFX.class.getResource("creditcard_page.fxml"));
